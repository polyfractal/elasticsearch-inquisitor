...
In addition to the standard analyzers that ElasticSearch provides, Inquisitor allows you to look at the output of your custom analyzers and on a per-field basis.  You can even build "AdHoc" analyzers using a mix a tokenizer and one or more filters.
